...
- Whether this guide needs its own dry-run acceptance test against a real cold participant before being treated as done, beyond Cowork's independent review and Cameron's ratification — raised during the discussion that produced this draft, not yet answered.
