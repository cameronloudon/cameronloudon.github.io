---
type: reference
title: "Work History Reference — Chronological Data and About-Page Voice Direction"
role: Publish
wrapper: Claude Code
identity: Sonnet 5
---

Canonical source for Cameron's career chronology and the About-page voice direction, used to build and maintain `about/work-history.html` and `about/about.html`. Moved out of `CLAUDE.md` 2026-08-16 during the instruction-set-redesign portability audit — this content is Cameron's own factual/biographical material, not Claude-Code-specific operational scaffolding, and existed nowhere else in any canonical file. A replacement Publish Agent tool needs this to maintain those pages; it would not have had access to it before this move except by scraping the already-published page itself.
