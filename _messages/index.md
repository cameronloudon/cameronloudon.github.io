...
2026-07-11 is a dense day (61 backlog files across roughly a dozen sub-threads). Batch-8 covered action-digest and aliases; batch-9 adds the audit-finding home decision, the link/wikilink convention build, provenance stamping and the provenance sidecar, the rescue-destination question, and Cowork's unauthorized-rescue disclosure — 24 of the day's 61 files across both batches. Still remaining, tracked in the Gaps section below rather than implied complete here: architecture-doc, auditor-charter/capture-convention, OKF pilot, and the Fable/Auditor first-mission-planning cluster.
